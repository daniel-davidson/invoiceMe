...
class HomeScreen extends ConsumerWidget {
          ...
          data: (vendors) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return VendorCard(
                  vendor: vendor,
                  onTap: () => context.push('/vendor/${vendor.id}/analytics'),
          ...
          ElevatedButton(
            onPressed: () async {
              if (nameController.text.isNotEmpty) {
                await ref.read(vendorsProvider.notifier).addVendor(nameController.text);
  ...
  void _showEditVendorDialog(BuildContext context, WidgetRef ref, dynamic vendor) {
                ...
                children: [
                  _UploadOption(
                    ...
                    onTap: () async {
                      ...
                      await ref.read(vendorsProvider.notifier).uploadFromCamera();
                    },
                  ),
                  _UploadOption(
                    ...
                    onTap: () async {
                      Navigator.pop(context);
                      await ref.read(vendorsProvider.notifier).uploadFromGallery();
                    },
                  ),
                  _UploadOption(
