...
export declare class ExtractionService {
    ...
    constructor(prisma: PrismaService, storage: StorageService, pdfProcessor: PdfProcessorService, ocr: OcrService, llmService: LlmService, vendorMatcher: VendorMatcherService, currency: CurrencyService, deterministicParser: DeterministicParserService);
    private toNumber;
